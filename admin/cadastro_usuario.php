        ...
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <div class="box box-primary">
                    ...
                    <!-- /.box-header -->
                    <!-- form start -->
                    <form name="form1" method="post" action="../backend/registersubmit.php">
                        ...
                        <div class="row">
                            <div class="col-xs-4">
                                <button type="submit" class="btn btn-primary btn-block btn-flat" name="adduser" value="adduser">Salvar</button>
                            </div>
                            <!-- /.col -->
                        </div>
                    </form>
